                                            ...
                                            <div style="width: 80%; margin: 100 auto; padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,0.1); border-radius: 8px; background: #FFF;">
                                                ...
                                                <form action="/report-incident" method="post" enctype="multipart/form-data">
                                                    <div style="margin-bottom: 20px;">
                                                        ...
                                                        <input type="text" id="title" name="title" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;" placeholder="Describe brevemente el problema">
                                                    </div>
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="description" style="font-weight: bold; display: block; margin-bottom: 10px;">Descripción</label>
                                                        <textarea id="description" name="description" rows="4" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;" placeholder="Escribe tu mensaje"></textarea>
                                                    </div>
                                                    <div style="margin-bottom: 20px;">
                                                        <label for="file-upload" style="font-weight: bold; display: block; margin-bottom: 10px;">Subir archivo</label>
                                                        <input type="file" id="file-upload" name="file-upload" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;">
                                                    </div>
