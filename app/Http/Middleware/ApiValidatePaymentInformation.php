...
class ApiValidatePaymentInformation
{
    /**
    ...
    {
        $errors = ApiRequestValidationService::validatePaymentInformation(ApiController::getRequestBody($request));
    ...
    {
        return [
            'error' => 'Invalid payment methdod payload',
