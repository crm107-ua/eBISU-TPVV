...
class ApiValidateRequestRefoundInformation
{
    /**
    ...
    {
        $errors = ApiRequestValidationService::validateRequestRefoundInformation(ApiController::getRequestBody($request));
    ...
    {
        return [
            'error' => 'Invalid refound information payload',
